...
const GhostFeetKeyframes = (fill: string) => keyframes`
  0% {
    box-shadow:
        4px 0 ${fill},
        8px 0 ${fill},
...
const GhostFeet = styled.div<GhostProps>`
  animation-name: ${(props) => (props.fill ? GhostFeetKeyframes(props.fill) : GhostFeetKeyframes('#FF0000'))};
  animation-duration: .4s;
  animation-fill-mode: forwards;
  animation-timing-function: steps(1);
  animation-iteration-count: infinite;
    
  background: ${(props) => (props.fill ? props.fill : '#FF0000')};
